...
import { getIssuesByFilter, getJiraFields } from "jozzos-backend";
import type { Issue } from "jozzos-backend";
import { groupIssuesByField, sortFieldValues } from "../utils/matrixUtils";
import {
  RefreshCw,
  Filter,
  AlertTriangle,
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            flexDirection: "column",
                            gap: "0.5rem",
                            opacity: isStatusClosed(issue.status) ? 0.55 : 1,
                          }}
                          onMouseEnter={(e) => {
